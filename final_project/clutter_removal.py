...
for jt in range(len(files)):
    ...
    if grf:
        ...
        print("Done with GRF!\n")
        # print("Optimization complete. Filtered data is in filtered_X_h_optimized and filtered_X_v_optimized.\n")
